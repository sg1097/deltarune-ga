...
if (EVENT == 43)
{
    ...
    with (CHOICE)
    {
        ...
        NAME[0][0] = scr_84_get_lang_string("DEVICE_CONTACT_slash_Step_0_gml_343_0", "A");
        NAME[0][1] = scr_84_get_lang_string("DEVICE_CONTACT_slash_Step_0_gml_344_0");
        NAME[0][2] = scr_84_get_lang_string("DEVICE_CONTACT_slash_Step_0_gml_345_0", "B");
        NAME[0][3] = scr_84_get_lang_string("DEVICE_CONTACT_slash_Step_0_gml_346_0", "C");
        NAME[0][4] = scr_84_get_lang_string("DEVICE_CONTACT_slash_Step_0_gml_347_0", "D");
        CURX = 0;
        HEARTX = NAMEX[0][0] - 20;
        HEARTY = NAMEY[0][0];
        XMAX = 0;
...
if (EVENT == 67)
{
    if (instance_exists(CHOICE))
    {
        ...
        if (FN_2 == "GASTER" || FN_2 == scr_84_get_lang_string("special_name_check_00", "GASTER") || FN_2 == "がすたー" || FN_2 == "ガスター")
        {
            snd_free_all();
            game_restart();
        }
...
if (EVENT == 71)
{
    if (instance_exists(CHOICE))
    {
        ...
        if (FN_3 == "GASTER" || FN_3 == scr_84_get_lang_string("special_name_check_00", "GASTER") || FN_3 == "がすたー" || FN_3 == "ガスター")
        {
            snd_free_all();
            game_restart();
        }
